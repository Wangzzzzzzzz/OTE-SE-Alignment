...
ALG_DICT = {
    ...
    "MEMIT_forget": (MEMITHyperParams, apply_memit_forgetting_to_model),
...
def main(
    ...
    if any(alg in alg_name for alg in ["AlphaEdit", "MEMIT_seq", "MEMIT_prune", "NSE", "MEMIT_forgetting","MEMIT_forget"]):
    ...
    for record_chunks in chunks(ds, num_edits):
        ...
        elif any(alg == alg_name for alg in ["MEMIT_forgetting","MEMIT_forget"]):
            edited_model, cache_c, total_upd_matrix = apply_algo(
                model,
                tok,
                [
                    {"case_id": record["case_id"], **rewrite_dict}
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        choices=["AlphaEdit","MEMIT_rect", 
                 ...
                 "MEMIT", "ROME", "FT", "MEND","NSE", "MEMIT_forgetting","MEMIT_forget"],
        default="ROME",
